...
/**
 * Refactored Immutable IncidentTicket using the Builder pattern.
 */
public final class IncidentTicket {
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .tags(new ArrayList<>(this.tags)) // Copy tags back for the builder
    ...
    public List<String> getTags() { return tags; } // Safe due to defensive copy and unmodifiable wrapping
